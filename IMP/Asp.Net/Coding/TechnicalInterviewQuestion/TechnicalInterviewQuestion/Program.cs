...
namespace TechnicalInterviewQuestion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //How can you find the angle between the hour and minute needles of a clock at any given time? Write a program for the same.
            int inputHrs = 9;
            int inputMin = 0;
